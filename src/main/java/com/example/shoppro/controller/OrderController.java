...
public class OrderController {
    ...
    // 사용자가 볼 수 있으므로, 따로 get으로 읽기페이지는 만들지 않는다.
...
//        }
        ...
        if (bindingResult.hasErrors()) {
            ...
            for (FieldError fieldError : fieldErrors) {
                log.info(fieldError.getField() + " 메시지 : " + fieldError.getDefaultMessage());
        ...
        if (result == null) {
            return new ResponseEntity<String>("주문수량이 판매수량보다 많습니다.", HttpStatus.OK);
        }
